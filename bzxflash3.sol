...
function kickAss(bytes32 loanId) onlyOwner public{
    //getLoan
   ...
   if(loanToken == 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2){
       tokenAddToUse = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;
   }
  ...
  function performTrade() public onlyOwner{
         ...
         ERC20 bzLToken     =  ERC20(currentLToken);
             ...
             if(bzLToken.allowance(address(this), bzx1Address) <=currentMaxLiq){
                    bzLToken.approve(bzx1Address, 100000000000000000000000000000000000);
             }
  ...
  function executeOperation(address _reserve, uint256 _amount, uint256 _fee, bytes calldata  _params) external {
        ...
        if(_reserve == 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE){
            ...
            wethToken.withdraw( (_amount+_fee));
              require(ourEthBalance>=(repayAmount), "Not enough eth");
